...
router.get('/sample_to_metabolite_measurements', acl.middleware(1),
    function(req, res) {
        models.
...
router.get('/sample_to_metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
        w = {
            where: {
                id: req.params.id
...
router.get('/sample_to_metabolite_measurements/example_csv', acl.middleware(1),
    function(req, res) {
...
// get for vue-table
router.get('/sample_to_metabolite_measurements/vue_table', acl.middleware(1),
    function(req, res) {
...
router.post('/sample_to_metabolite_measurements', acl.middleware(1),
    function(req, res) {
...
router.post('/sample_to_metabolite_measurements/upload_csv', acl.middleware(1),
    function(req, res) {
...
router.post('/sample_to_metabolite_measurements/upload_xlsx', acl.middleware(1),
    function(req, res) {
...
router.put('/sample_to_metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
...
router.delete('/sample_to_metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
