...
router.get('/metabolite_measurements', acl.middleware(1),
    function(req, res) {
        models.
...
router.get('/metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
        w = {
            where: {
                id: req.params.id
...
router.get('/metabolite_measurements/example_csv', acl.middleware(1),
    function(req, res) {
...
// get for vue-table
router.get('/metabolite_measurements/vue_table', acl.middleware(1),
    function(req, res) {
...
router.post('/metabolite_measurements', acl.middleware(1),
    function(req, res) {
...
router.post('/metabolite_measurements/upload_csv', acl.middleware(1),
    function(req, res) {
...
router.post('/metabolite_measurements/upload_xlsx', acl.middleware(1),
    function(req, res) {
...
router.put('/metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
...
router.delete('/metabolite_measurement/:id', acl.middleware(1),
    function(req, res) {
