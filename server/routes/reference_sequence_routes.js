...
router.get('/reference_sequences', acl.middleware(1),
    function(req, res) {
        models.
...
router.get('/reference_sequence/:id', acl.middleware(1),
    function(req, res) {
        w = {
            where: {
                id: req.params.id
...
router.get('/reference_sequences/example_csv', acl.middleware(1),
    function(req, res) {
...
// get for vue-table
router.get('/reference_sequences/vue_table', acl.middleware(1),
    function(req, res) {
...
router.post('/reference_sequences', acl.middleware(1),
    function(req, res) {
...
router.post('/reference_sequences/upload_csv', acl.middleware(1),
    function(req, res) {
...
router.post('/reference_sequences/upload_xlsx', acl.middleware(1),
    function(req, res) {
...
router.put('/reference_sequence/:id', acl.middleware(1),
    function(req, res) {
...
router.delete('/reference_sequence/:id', acl.middleware(1),
    function(req, res) {
