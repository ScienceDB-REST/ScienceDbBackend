...
// get CSV of all sample_to_sample_measurements
router.get('/sample_to_sample_measurements/csv_export', acl.middleware(1),
    function(req, res) {
        helper.csvExport(models.sample_to_sample_measurement).then(function(csvStr) {
            res.set({
                'Content-Disposition': 'attachment; filename=sample_to_sample_measurements.csv',
